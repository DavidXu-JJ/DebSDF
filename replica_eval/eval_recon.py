...
def calc_3d_metric(rec_meshfile, gt_meshfile, align=False):
    ...
    print(
        f'accuracy_rec:{accuracy_rec}\tcompletion_rec:{completion_rec}\tchamfer:{chamfer}\tprecision_ratio_rec:{precision_ratio_rec}\t'
        f' completion_ratio_rec:{completion_ratio_rec}\tfscore:{fscore}\tnormal_acc:{normal_acc}\t'
        f' normal_comp:{normal_comp}\tnormal_avg:{normal_avg}'
    )
